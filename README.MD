...
| 2 — Ingestion Lambda | Code complete, unit tested, fetch verified against the real Pollen API — needs `sam deploy` + a live table to verify the DynamoDB write end to end |
