...
Shared by the ingest, notify, and confirm Lambdas so all three read the same env var names.
...
# Used by the notify Lambda as the SES "From" address -- must be a verified SES identity.
