"""Sample fetch against the Google Pollen API forecast:lookup endpoint.

Purpose: a throwaway script to see the real response shape for a location, so the ingestion
Lambda's parsing logic can be written against the actual schema instead of guessing.
